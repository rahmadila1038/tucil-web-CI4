    ...
    <div class="col-md-6">
      <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <p class="card-text mb-auto">Skin Aqua UV Moisture Milk SPF 50 PA+++ diklaim dapat memberikan perlindungan 51x lebih lama terhadap sinar matahari yang menyebabkan kulit terbakar. </p>
