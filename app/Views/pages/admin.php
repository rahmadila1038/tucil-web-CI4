      ...
      <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <p class="card-text mb-auto">Skin Aqua UV Moisture Milk SPF 50 PA+++ diklaim dapat memberikan perlindungan 51x lebih lama terhadap 
            ...
            <a href="/pages/detailProduk/skinAqua" class="stretched-link">...Continue reading</a> 
      ...
      <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <p class="mb-auto">lip balm bagi sebagian orang merupakan kosmetik pertama yang menyentuh bibirnya. 
            Teksturnya ringan memberikan hasil warna yang na<a href="/pages/detailProduk/lipBalm" class="stretched-link">...Continue reading</a>.
          <br><button type="submit" class="btn btn-danger">Hapus</button>
          <button type="submit" class="btn btn-info">Edit</button></p>
        </div>
        <div class="col-auto d-none d-lg-block">
      ...
      <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <p class="mb-auto">Nivea, baru-baru ini mengeluarkan produk  micellar water terbarunya, yaitu MicellAIR. Nivea MicellAIR ini memiliki dua jenis, 
            ...
            <a href="/pages/detailProduk/MWNivea" class="stretched-link">...Continue reading</a>
            <br><button type="submit" class="btn btn-danger">Hapus</button>
          <button type="submit" class="btn btn-info">Edit</button> </p>
        </div>
        <div class="col-auto d-none d-lg-block">
      ...
      <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <p class="mb-auto">Sebagai pemilik mata kecil dengan bulu mata yang tipis dan pendek, maskara dan eyeliner 
            ...
            <a href="/pages/detailProduk/maybelline" class="stretched-link">...Continue reading</a>
            <br><button type="submit" class="btn btn-danger">Hapus</button>
          <button type="submit" class="btn btn-info">Edit</button> </p>
        </div>
        <div class="col-auto d-none d-lg-block">
